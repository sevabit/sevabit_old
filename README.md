...
* If you would like a specific [version/tag](https://github.com/sevabit-project/sevabit/tags), do a git checkout for that version. eg. '0.3.0'. If you dont care about the version and just want binaries from master, skip this step:
